<%-- 
    Document   : index
    Created on : 3 Jun, 2016, 6:47:59 PM
    Author     : sankalp
--%>
...
<div class="container">
        ...
        <div class="span12">
            <div class="page-header">
                <div class="span1" style="margin-left: 0; margin-right: 20px;">
                    <img src="http://vlabs.iitb.ac.in/sbhs/static/img/iitbLogo.png" alt="IITB">
                </div>
    ...
    <div class="container">
        ...
        <small style="float: right; font-size: 10px; margin: -8px 10px 2px 0;">Server time: <span id="timer"> Jun 2016 07:42:18 PM</span>. Copyright &copy; 2014 <a href="www.iitb.ac.in" target="_blank">www.iitb.ac.in</a>. Designed and hosted by <a href="http://www.cdeep.iitb.ac.in/" target="_blank">Automation Lab, CDEEP, IIT Bombay</a></small>
    </div>
</div>
  ...
  <!-- master_sankalp gupta -->
    ...
    <div class="navbar-inner">
        <div class="container">
            <ul class="nav pull-right">
                <li><a href="http://vlabs.iitb.ac.in/sbhs/info">SBHS InfoCentre</a></li>
